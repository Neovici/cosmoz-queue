...
`})),Ut,Wt,Gt,Kt=e((()=>{pe(),Ke(),Qe(),zt(),n(),te(),Bt(),Ht(),Ut=({next:e,prev:n})=>t` <button
		...
		${[Q(`of`),a??Q(`many`)].join(` `)}
	</div>`}));export{te as _,Vt as a,Q as c,ze as d,Be as f,L as g,Le as h,Gt as i,Ke as l,Ie as m,Ut as n,Ht as o,Re as p,Wt as r,zt as s,Kt as t,We as u};
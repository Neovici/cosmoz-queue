import{t as e}from"./chunk-BvrOYcoh.js";import{a as t,o as n,r,t as i}from"./lit-html-B0z-6tlh.js";import{a,c as o,i as s,n as c,r as l,s as u,t as d}from"./iframe-DUrQYmMs.js";import{_ as f,a as p,c as m,d as h,f as g,i as _,l as v,m as y,n as b,o as x,p as S,r as C,s as w,t as T,u as E}from"./haunted-I0Oiii6k.js";var D,O,k=e((()=>{n(),w(),l(),D=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},O=p(class extends x{constructor(e){if(super(e),e.type!==m.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,i]){let s=d(e),{values:l,keys:f}=this.dt(t,n,i);if(!Array.isArray(s))return this.ut=f,l;let p=this.ut??=[],m=[],h,g,_=0,v=s.length-1,y=0,b=l.length-1;for(;_<=v&&y<=b;)if(s[_]===null)_++;else if(s[v]===null)v--;else if(p[_]===f[y])m[y]=u(s[_],l[y]),_++,y++;else if(p[v]===f[b])m[b]=u(s[v],l[b]),v--,b--;else if(p[_]===f[b])m[b]=u(s[_],l[b]),o(e,m[b+1],s[_]),_++,b--;else if(p[v]===f[y])m[y]=u(s[v],l[y]),o(e,s[_],s[v]),v--,y++;else if(h===void 0&&(h=D(f,y,b),g=D(p,_,v)),h.has(p[_]))if(h.has(p[v])){let t=g.get(f[y]),n=t===void 0?null:s[t];if(n===null){let t=o(e,s[_]);u(t,l[y]),m[y]=t}else m[y]=u(n,l[y]),o(e,s[_],n),s[t]=null;y++}else c(s[v]),v--;else c(s[_]),_++;for(;y<=b;){let t=o(e,m[b+1]);u(t,l[y]),m[y++]=t}for(;_<=v;){let e=s[_++];e!==null&&c(e)}return this.ut=f,a(e,m),r}})})),A,j,M=e((()=>{n(),_(),w(),A=new WeakMap,j=p(class extends C{render(e){return i}update(e,[t]){let n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),i}rt(e){if(this.isConnected||(e=void 0),typeof this.G==`function`){let t=this.ht??globalThis,n=A.get(t);n===void 0&&(n=new WeakMap,A.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G==`function`?A.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}})})),N,P,F,I=e((()=>{n(),w(),N=`important`,P=` !`+N,F=p(class extends x{constructor(e){if(super(e),e.type!==m.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(P);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?N:``):n[e]=r}}return r}})})),ee,L,te=e((()=>{n(),w(),ee={},L=p(class extends x{constructor(){super(...arguments),this.ot=ee}render(e,t){return t()}update(e,[t,n]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every((e,t)=>e===this.ot[t]))return r}else if(this.ot===t)return r;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,n)}})})),ne,re=e((()=>{ne=e=>e})),ie,ae=e((()=>{re(),ie=class extends Promise{constructor(e){let t={};super((e,n)=>Object.assign(t,{resolve:e,reject:n})),Object.assign(this,t),e?.(t.resolve,t.reject)}resolve=()=>{}}})),oe,se,ce,le,ue=e((()=>{T(),k(),M(),I(),te(),ae(),oe={host:{position:`relative`,display:`flex`,overflow:`hidden`},slide:{position:`static`,width:`100%`,height:`100%`}},se=e=>{let{slide:t}=e,[n,r]=E([]);return h(()=>void Object.assign(e.style,oe.host),[]),y(()=>{if(t==null)return;let e={animationEnd$:new ie,...t};r((t=[])=>{let n=t.findIndex(({id:t,out:n})=>t===e.id&&n!==!0);return n===-1?[...t,e]:[...t.slice(0,n),e,...t.slice(n+1,t.length)]})},[t]),h(async()=>{if(n.filter(e=>!e.out).length<2){let e=n[0];e&&requestAnimationFrame(()=>requestAnimationFrame(()=>e.animationEnd$.resolve()));return}let e=n[n.length-1],t=n[n.length-2],i=e.el,a=t.el;t.out=!0,i&&a&&await e.animation?.(i,a),r((e=[])=>e.filter(e=>e!==t))},[n]),{slides:n}},ce=e=>t`<div
		${j(t=>Object.assign(e,{el:t}))}
		class="slide"
		style=${F(oe.slide)}
	>
		${L([e],()=>e.content??e.render?.(e))}
	</div>`,le=({slides:e})=>L([e],()=>O(e,({id:e})=>e,ce))})),de,fe=e((()=>{T(),ue(),de=e=>le(se(e)),customElements.define(`cosmoz-slider`,b(de,{useShadowDOM:!1}))})),pe=e((()=>{})),me=e((()=>{T(),n()})),he=e((()=>{fe(),me(),pe(),ue()})),ge=e((()=>{T()})),_e,ve=e((()=>{_e=(e,...t)=>e.flatMap((e,n)=>[e,t[n]??``]).join(``)})),ye=e((()=>{})),be=e((()=>{ge(),ve(),ye()})),xe,Se=e((()=>{be(),xe=_e`
	:host {
...
`})),Ut,Wt,Gt,Kt=e((()=>{he(),Ke(),Qe(),zt(),n(),te(),Bt(),Ht(),Ut=({next:e,prev:n})=>t` <button
		...
		>
			${$}
		</button>`,Wt=e=>{if(!e)return i;let{pageNumber:n=-1,onPage:r}=e,a=e.totalPages??Math.ceil((e.totalAvailable??0)/(e.pageSize??0));return t` <div class="tabn-pagination">
		<button
	...
	</div>`},Gt=({pagination:e,index:n,items:r,totalAvailable:a,nav:o,activeTab:s})=>r.length<1?i:t`<div class="tabn-stats">
		...
		${[Q(`of`),a??Q(`many`)].join(` `)}
	</div>`}));export{te as _,Vt as a,Q as c,Be as d,Re as f,L as g,re as h,Gt as i,Ke as l,ne as m,Ut as n,Ht as o,ze as p,Wt as r,zt as s,Kt as t,We as u};
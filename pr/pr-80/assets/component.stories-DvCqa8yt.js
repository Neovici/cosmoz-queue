import{t as e}from"./chunk-BvrOYcoh.js";import{a as t,o as n,r,t as i}from"./lit-html-B0z-6tlh.js";import{i as a,r as o}from"./iframe-Wbjr-eSB.js";import{_ as s,a as c,d as l,g as u,h as d,i as f,m as p,n as m,r as ee,s as te,t as h,u as ne}from"./haunted-CwpXWIMl.js";import{_ as re,a as g,c as _,d as ie,f as ae,g as oe,h as se,i as ce,l as le,m as ue,o as de,p as fe,s as pe,t as me,u as he}from"./render-B3hGmVqr.js";var v,y,b=e((()=>{v=e=>t=>{let n=t.match(e);return n&&{result:n,url:new URL(t,document.location.origin)}},y=(e,t)=>{for(let n of e){let e=n.rule,r=typeof e==`function`?e(t):v(e)(t);if(r)return{...n,route:n,match:r,url:t}}}})),ge=e((()=>{h()})),x,S,C,w,T=e((()=>{h(),b(),x=()=>window.location.href.replace(window.location.origin,``),S=()=>{let[e,t]=l(x);return d(()=>{let e=()=>t(x);return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[t]),e},C=e=>{let t=S();return p(()=>y(e,t),[e,t])},w=(e,t=null,{notify:n=!0,replace:r=!0}={})=>{(r?history.replaceState:history.pushState).call(history,t,``,e),n&&queueMicrotask(()=>window.dispatchEvent(new CustomEvent(`popstate`,{bubbles:!1})))}})),E,D=e((()=>{h(),T(),E=e=>{let t=C(e);return{route:t,result:p(()=>{if(t){let{handle:e,...n}=t;return e(n)}},[t])}}})),O,k,_e=e((()=>{O=class{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}},k=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(e=>this.Z=e)}resume(){this.Z?.(),this.Y=this.Z=void 0}}})),A,j,M,N,ve=e((()=>{n(),o(),f(),_e(),te(),A=e=>!a(e)&&typeof e.then==`function`,j=1073741823,M=class extends ee{constructor(){super(...arguments),this._$Cwt=j,this._$Cbt=[],this._$CK=new O(this),this._$CX=new k}render(...e){return e.find(e=>!A(e))??r}update(e,t){let n=this._$Cbt,i=n.length;this._$Cbt=t;let a=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let r=t[e];if(!A(r))return this._$Cwt=e,r;e<i&&r===n[e]||(this._$Cwt=j,i=0,Promise.resolve(r).then(async e=>{for(;o.get();)await o.get();let t=a.deref();if(t!==void 0){let n=t._$Cbt.indexOf(r);n>-1&&n<t._$Cwt&&(t._$Cwt=n,t.setValue(e))}}))}return r}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}},N=c(M)})),P,F,ye=e((()=>{h(),P=(e,t,n)=>e.dispatchEvent(new CustomEvent(t,{bubbles:!1,cancelable:!1,composed:!0,...n})),F=(e,t,n)=>{d(()=>{if(!n){P(e,`route-not-found`);return}P(e,`route-loading`,{detail:t}),Promise.resolve(n).then(()=>P(e,`route-loaded`,{detail:t})).catch(n=>P(e,`route-error`,{detail:{route:t,error:n}}))},[n])}})),I,be=e((()=>{n(),re(),ve(),h(),D(),ye(),I=e=>{let t=e.routes,{route:n,result:r}=E(t);return F(e,n,r),oe([r],()=>N(Promise.resolve(r).catch(()=>i),i))},customElements.define(`cosmoz-router`,m(I))})),xe=e((()=>{b(),ge(),T(),D(),be()})),L,R,z,B,Se=e((()=>{h(),se(),ie(),xe(),L=e=>{let t=ne(void 0);return d(()=>void(t.current=e),[e]),t.current},R=(e,t,n,r)=>e.find(e=>n(e)===n(t))??e[r]??e[0],z=(e,t,n)=>e.find(e=>n(e)===t)??e[0],B=(e,{id:t=ue,hashParam:n,maintainSelection:r})=>{let[i,a]=l(()=>e[0]),[o]=fe(n),s=p(()=>e.indexOf(i),[e,i]),c=L(s),{prev:u,next:f}=p(()=>{let t=e.length-1;return{...s>0&&{prev:()=>a(e[Math.max(0,Math.min(t,s-1))])},...s<t&&{next:()=>a(e[Math.max(0,Math.min(t,s+1))])}}},[e,s]);return d(()=>{!i||!n||w(ae(n,t(i)),null,{notify:!1})},[i]),d(()=>{e.length!==0&&a(n=>!n&&o!=null?z(e,o,t):e.indexOf(n)>=0?n:!n||!r?e[0]:R(e,n,t,c))},[e,o]),{forward:s>c,index:s,item:i,items:e,setItem:a,prev:u,next:f}}})),Ce=e((()=>{h(),s(class extends u{update(){return this.state.host}})})),we=e((()=>{h()})),V,Te=e((()=>{h(),Ce(),we(),V=()=>{let[e,t]=l(),[n,r]=l([]),[i,a]=l([]);return{totalAvailable:e,setTotalAvailable:t,items:n,setItems:r,selected:i,setSelected:a}}})),H,U,W,G=e((()=>{n(),H=t` <svg
	width="18"
	height="14"
	viewBox="0 0 18 14"
	fill="none"
...
`})),K,Ee=e((()=>{le(),h(),pe(),G(),K=({items:e,hashParam:t,mobile:n,fallback:r,onActivate:i})=>{let a=he(p(()=>[{name:`overview`,title:_(`List`),disabled:!1,content:H},{name:`split`,disabled:n||!(e.length>0),title:_(`Split`),content:W},{name:`queue`,disabled:!(e.length>0),title:_(`Queue`),content:U}].map(e=>e.name===r?{...e,fallback:!0}:e),[e.length,n,r]),{hashParam:t,onActivate:i}),o=p(()=>a,Object.values(a));return{activeTab:o.active?.name,tabnav:o}}})),q,J,Y,X,Z,Q,$;e((()=>{h(),n(),me(),de(),Se(),Te(),Ee(),q={title:`Components/Queue`,component:`cosmoz-queue`},J=[{id:`1`,name:`Task Alpha`,description:`Complete the project setup`,status:`active`},{id:`2`,name:`Task Beta`,description:`Review code changes`,status:`pending`},{id:`3`,name:`Task Gamma`,description:`Write documentation`,status:`active`},{id:`4`,name:`Task Delta`,description:`Run tests`,status:`completed`},{id:`5`,name:`Task Epsilon`,description:`Deploy to staging`,status:`pending`}],Y=()=>{let{items:e,setItems:n,totalAvailable:r,setTotalAvailable:i}=V();e.length===0&&(n(J),i(J.length));let{activeTab:a,tabnav:o}=K({items:e.length>0?e:J,fallback:`overview`}),s=B(e.length>0?e:J,{id:e=>e.id,hashParam:void 0}),c=e=>{s.setItem(e),a===`overview`&&o.activate(`queue`)};return t`
    ...
    `},X=m(Y,{observedAttributes:[],useShadowDOM:!0,styleSheets:[g]}),customElements.get(`cosmoz-queue-demo`)||customElements.define(`cosmoz-queue-demo`,X),Z=()=>t`
    <div
